...
import { WebsLeadsInfo } from "../../components/WebsLeadsInfo/WebsLeadsInfo";
import { CRMInfo } from "../../components/CRMInfo/CRMInfo";
                    ...
                    <div className={titleContainerClass}>
                        <div className={titleTextClass}>
                            <p>
                                ...
                                laudantium cum aliquid explicabo.
                            </p>
                            {isMobile ? (
                ...
                <div className="info-panel">
                    <div
                        className={`info-container ${
                            isMobile ? "info-container-mobile" : ""
                        }`}
                    >
